    ...
    try:
        ...
        while True:
            try:
                ...
                print(f'     - IP Version\t: {Fore.GREEN}{str(split_version_IHL.bin[:6])}{Style.RESET_ALL}')
                print(f'     - IP Header Length (IHL)\t: {Fore.GREEN}{str(split_version_IHL.bin[6:])}{Style.RESET_ALL}')
