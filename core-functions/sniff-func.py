    ...
    try:
        ...
        while True:
            try:
                ...
                ip = struct.unpack('!BBBHHHBBH4s4s', ip_header)
                print(f'[{Fore.CYAN}!{Style.RESET_ALL}] {Fore.CYAN}IP Header:{Style.RESET_ALL}')
                print(f'     - IP Version\t: {Fore.GREEN}{ip[0]}{Style.RESET_ALL}')
                print(f'     - IP Header Length (IHL)\t: {Fore.GREEN}{ip[1]}{Style.RESET_ALL}')
                print(f'     - Type of Service (TOS)\t: {Fore.GREEN}{ip[2]}{Style.RESET_ALL}')
                print(f'     - Total Length\t: {Fore.GREEN}{ip[3]}{Style.RESET_ALL}')
                print(f'     - Identification\t: {Fore.GREEN}{ip[4]}{Style.RESET_ALL}')
                print(f'     - Fragment Offset\t: {Fore.GREEN}{ip[5]}{Style.RESET_ALL}')
                print(f'     - Time-to-Live (TTL)\t: {Fore.GREEN}{ip[6]}{Style.RESET_ALL}')
                print(f'     - Protocol\t\t: {Fore.GREEN}{ip[7]}{Style.RESET_ALL}')
                print(f'     - Header Checksum\t: {Fore.GREEN}{ip[8]}{Style.RESET_ALL}')
                print(f'     - Source IP \t: {Fore.GREEN}{socket.inet_ntoa(ip[9])}{Style.RESET_ALL}')
                print(f'     - Destination IP \t: {Fore.GREEN}{socket.inet_ntoa(ip[10])}{Style.RESET_ALL}')
