...
def getEthernetHeader(eth):
    ...
    print('     Src. MAC : {Fore.GREEN}{0}{Style.RESET_ALL}, Dest. MAC : {Fore.GREEN}{1}{Style.RESET_ALL}'.format(
...
def getIPHeader(ip):
    ...
    print('     IP Version : {Fore.GREEN}{0} ({1}){Style.RESET_ALL}, Protocol : {Fore.GREEN}{2}{Style.RESET_ALL}'.format(
        split_version_IHL.bin[:4], int(split_version_IHL.bin[:4], 2), proto=ip[6]
        ))
    print('     Src. IP : {Fore.GREEN}{0}{Style.RESET_ALL}, Dest. IP : {Fore.GREEN}{1}{Style.RESET_ALL}'.format(
...
def getTCPHeader(tcp):
    ...
    print('     Src. Port : {Fore.GREEN}{0}{Style.RESET_ALL}, Dest. Port : {Fore.GREEN}{1}{Style.RESET_ALL}'.format(
        tcp[0], tcp[1]
    ))
    print('     Flags : {Fore.GREEN}{split_HL_flags[4:] + split_flags[0:]}{Style.RESET_ALL}')
    print('       URG : {Fore.GREEN}{0}{Style.RESET_ALL}, ACK : {Fore.GREEN}{1}{Style.RESET_ALL}, PSH : {Fore.GREEN}{2}{Style.RESET_ALL}'
          .format(split_flags.bin[2], split_flags.bin[3], split_flags.bin[4]))
    print('       RST : {Fore.GREEN}{0}{Style.RESET_ALL}, SYN : {Fore.GREEN}{1}{Style.RESET_ALL}, FIN : {Fore.GREEN}{2}{Style.RESET_ALL}'
...
def getICMPHeader(icmp):
    ...
    print('     Type : {Fore.GREEN}{0}{Style.RESET_ALL}, Code : {Fore.GREEN}{1}{Style.RESET_ALL}'.format(
        icmp[0], icmp[1]  
    ))
    print(f'     Identifier\t: {Fore.GREEN}{icmp[3]}{Style.RESET_ALL}')
