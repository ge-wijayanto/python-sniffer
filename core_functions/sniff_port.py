...
def getEthernetHeader(eth):
    ...
    print(f'     - Destination MAC\t\t: {Fore.GREEN}{eth[0].upper()}{Style.RESET_ALL}')
    print(f'     - Source MAC\t\t: {Fore.GREEN}{eth[1].upper()}{Style.RESET_ALL}')
    print(f'     - Type/Length\t\t: {Fore.GREEN}{eth[2]}{Style.RESET_ALL}')
